...
class digital_mod_analysis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "digital_mod_analysis")
        ...
        self.radar_signal_generator_sync_pulse_c_0 = radar.signal_generator_sync_pulse_c(100, [1], [2], 1, "packet_len")
        ...
        self.connect((self.radar_signal_generator_cw_c_0, 0), (self.blocks_multiply_xx_0, 1))
...
def main(top_block_cls=digital_mod_analysis, options=None):
